#!/usr/bin/env python3
"""Aggregate D5 verified-attention source-validation chains against attention."""
...
def main() -> None:
    ...
    for fold in folds:
        ...
        for candidate in CANDIDATES:
            ...
            mean, low, high = bootstrap_mean(delta, args.bootstrap_replicates, 20267000 + len(rows))
            rows.append(
                {
                    "fold": fold,
                    "candidate": candidate,
    ...
    candidate = per_fold[per_fold.candidate == "D5_verified_attention_chain"].merge(base, on="fold", validate="one_to_one")
    ...
    decision = {
        ...
        "selected_candidate": "D5_verified_attention_chain" if qualified else None,
